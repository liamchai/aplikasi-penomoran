<div class="row">
    <aside class="col-2 bg-secondary list-group pr-0 pl-3 aside">
        ...
        @endforeach
        <hr class="border border-dark m-0">
        <a class="text-dark list-group-item list-group-item-action bg-secondary border-0" href="{{ route('logout') }}">Logout</a>
    </aside>
<div class="col-10">
